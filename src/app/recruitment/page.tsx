              ...
              {jobs.slice(0, 5).map((job) => (
                <div key={job.id} className="p-4 border-b last:border-b-0 hover:bg-muted/50">
                  <div className="flex justify-between items-start">
                    ...
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${job.status === 'open' ? 'bg-green-500/10 text-green-600' :
              ...
              {candidates.slice(0, 5).map((candidate) => (
                <div key={candidate.id} className="p-4 border-b last:border-b-0 hover:bg-muted/50">
                  <div className="flex justify-between items-start">
                    ...
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${candidate.stage === 'new' ? 'bg-muted text-muted-foreground' :
