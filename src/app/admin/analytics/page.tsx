...
const analyticsModules = [
    {
        ...
        description: 'Heatmap de RUA (Resiliência, Utilidade, Ambição) e conversão SMART.',
    ...
    },
    {
        ...
        description: 'Monitoramento de rotatividade e motivos de desligamento.',
    ...
    },
    {
        ...
        description: 'Eficiência de onboarding e progresso de novos talentos (D90).',
